...
extern void         machdep_profile_init(void);
extern void         machdep_profile_reset(void);
extern unsigned int machdep_profile_sample(void);
extern unsigned int machdep_profile_sample_and_log(unsigned int start, char s[]);
extern void         machdep_profile_print_logged_samples(void);
