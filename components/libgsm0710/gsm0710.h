...
#define GSM0710_BUFFER_SIZE             8192
#define GSM0710_DEFAULT_FRAME_SIZE      31
#define GSM0710_MAX_CHANNELS            63
#define GSM0710_FRAME_BUFFER_SIZE       512    /* Static frame buffer for MUX frames */
...
typedef    void    (*gsm0710_context_lock_callback)(struct gsm0710_context *ctx);
typedef    void    (*gsm0710_context_unlock_callback)(struct gsm0710_context *ctx);
...
struct gsm0710_context
{
    ...
    gsm0710_context_lock_callback lock;
    gsm0710_context_unlock_callback unlock;
};
